...
Select * from lookup.roster where year in (2019) limit 10;

desc lookup.roster;

###drop table loaddata.roster_q3_2019;
/*
select * from loaddata.roster_q3_2019;
select count(*) from loaddata.roster_q3_2019;
