...
Select * from  loaddata.q1q2_2021_roster  limit 10;
desc loaddata.q1q2_2021_roster;
desc lookup.roster;
...
SELECT ORIG_SEQ AS rosterid,
       ...
       " " AS UserClass,
       " " as ReportRole
from loaddata.q1q2_2021_roster;
...
/*
SET sql_mode = '';
create table loaddata.rosterBU20210901 AS select * from lookup.roster;
