...
select * from loaddata.roster_update_2022_20230209;


create table work.rosterstr as 
Select * from  work.RosterNewRec  limit 10;


desc work.RosterNewRec;
desc lookup.roster;
...
### BACKUP ROSTER
SET sql_mode = '';
create table loaddata.rosterBU20230209 AS select * from lookup.roster;
