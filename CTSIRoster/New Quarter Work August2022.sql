...
Select * from  loaddata.q1q2_2022_roster  limit 10;
desc loaddata.q1q2_2022_roster;
desc lookup.roster;
...
SELECT ORIG_SEQ AS rosterid,
       ...
       " " AS UserClass,
       " " as ReportRole
from loaddata.q1q2_2022_roster;
...
/*
SET sql_mode = '';
create table loaddata.rosterBU20220825 AS select * from lookup.roster;
...
select Year,Count(*) as nREC, count(distinct Person_Key) nUnDUP
from loaddata.rosterBU20220825
group by Year;
