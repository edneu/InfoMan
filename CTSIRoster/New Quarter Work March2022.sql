...
Select * from  loaddata.q1q4_2021_roster  limit 10;
desc loaddata.q1q4_2021_roster;
desc lookup.roster;
...
SELECT ORIG_SEQ AS rosterid,
       ...
       " " AS UserClass,
       " " as ReportRole
from loaddata.q1q4_2021_roster;
...
###UPDATE lookup.roster SET DOB=NULL where DOB='0000-00-00 00:00:00';

select count(*) from loaddata.rosterBU20220311 where Year=2021;

/*
SET sql_mode = '';
create table loaddata.rosterBU20220311 AS select * from lookup.roster;

DESC lookup.roster;
DESC work.roster_additions;

ALTER TABLE work.roster_additions 
DROP COLUMN Report_Program,
DROP COLUMN Rept_Program2;
...
select Year,Count(*) as nREC, count(distinct Person_Key) nUnDUP
from loaddata.rosterBU20220311
group by Year;
