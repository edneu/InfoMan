...
ALTER TABLE brian.roster_upstairs MODIFY UFID varchar(12);
...
####
UPDATE work.roster_additions SET Lastname='Yin', Firstname='Rui' where rosterid=864;
UPDATE work.roster_additions SET Lastname='El Hayek' where rosterid=483;
...
select * from work.roster_additions where FacType is null;
...
### BACKUP ROSTER
SET sql_mode = '';
create table loaddata.rosterBU20240213 AS select * from lookup.roster;
