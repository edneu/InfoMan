...
select sr.CLK_AWD_PI,
       ...
       sp.ROOM  
from work.bondSRMRoom sr LEFT JOIN space.ctrb_projects_2018 sp ON sr.CLK_AWD_PROJ_ID=sp.PRJNUM ;
...
from work.bondSRMProj bsp LEFT JOIN space.ctrb_occ_2018 occ ON bsp.ROOM=occ.ROOM
