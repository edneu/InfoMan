...
WHERE CLK_AWD_PROJ_ID IN (select distinct PRJNUM from space.ctrb_projects_2019)
...
select sr.CLK_AWD_PI,
       ...
       sp.ROOM  
from work.bondSRMRoom sr LEFT JOIN space.ctrb_projects_2019 sp ON sr.CLK_AWD_PROJ_ID=sp.PRJNUM ;
...
from work.bondSRMProj bsp LEFT JOIN space.ctrb_occ_2019 occ ON bsp.ROOM=occ.ROOM
