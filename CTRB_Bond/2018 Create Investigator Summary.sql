...
Select * from space.ctrb_projects_2018
...
from work.bondprojspace bs LEFT JOIN space.ctrb_occ_2018 oc
ON bs.ROOM=oc.ROOM
...
drop table if exists space.bondprojroom2018;
create table space.bondprojroom2018
AS SELECT * from work.bondprojroom;
