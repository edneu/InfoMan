...
Drop Table if Exists work.Span48;
create table work.Span48 as
select * from work.survey_bondmaster where Span=48;
############################################################################################
...
#SET innodb_log_file_size = 500M;
SET innodb_log_buffer_size = 800M;
...
Select st2.AWARD_INV_UFID,
      ...
      s48.AWARD_ID as Project48,
      s48.SponsorName as Agency48,
      s48.SponsorID as AgNo48,
      s48.Sponsor_Type as AgencyType48, 
      s48.Title as Title48
...
from work.SurveyTable2 st2
	...
	left join work.Span48 s48 on st2.AWARD_INV_UFID=s48.AWARD_INV_UFID
