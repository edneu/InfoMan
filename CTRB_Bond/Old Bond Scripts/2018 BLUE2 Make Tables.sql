...
UPDATE space.colonylist SET PctArea=Area/36513.5206;
...
UPDATE space.salary
       SET Salary=SalaryRaw*1.090,      
           Fringe=FringeAmtRaw*1.090,
           SalFringe=(SalaryRaw+FringeAmtRaw)*1.090,
           KeepFund=1,
           GoodMask=0,
	       BadMask=0;
