...
SELECT awd.AWARD_ID_TYPE,
       ...
       max(srm.CLK_AWD_PROJ_NAME) AS Title,
...
UPDATE work.bondmaster bm, space.bondmaster2016 sh
...
select * from space.bondmaster2016;
...
UPDATE work.bondmaster bm, space.bondmaster2016 sly
