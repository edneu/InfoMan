...
left join work.Span26 s26
on st1.AWARD_INV_UFID=s26.AWARD_INV_UFID
left join work.Span27 s27
on st1.AWARD_INV_UFID=s27.AWARD_INV_UFID
left join work.Span28 s28
on st1.AWARD_INV_UFID=s28.AWARD_INV_UFID
left join work.Span29 s29
on st1.AWARD_INV_UFID=s29.AWARD_INV_UFID
left join work.Span30 s30
on st1.AWARD_INV_UFID=s30.AWARD_INV_UFID
left join work.Span31 s31
on st1.AWARD_INV_UFID=s31.AWARD_INV_UFID
left join work.Span32 s32
on st1.AWARD_INV_UFID=s32.AWARD_INV_UFID
left join work.Span33 s33
on st1.AWARD_INV_UFID=s33.AWARD_INV_UFID
left join work.Span34 s34
on st1.AWARD_INV_UFID=s34.AWARD_INV_UFID
left join work.Span35 s35
on st1.AWARD_INV_UFID=s35.AWARD_INV_UFID
left join work.Span36 s36
on st1.AWARD_INV_UFID=s36.AWARD_INV_UFID
left join work.Span37 s37
on st1.AWARD_INV_UFID=s37.AWARD_INV_UFID
left join work.Span38 s38
on st1.AWARD_INV_UFID=s38.AWARD_INV_UFID
left join work.Span39 s39
on st1.AWARD_INV_UFID=s39.AWARD_INV_UFID
