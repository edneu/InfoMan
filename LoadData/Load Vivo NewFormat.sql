...
drop table if exists loaddata.vivomar2018;
CREATE TABLE loaddata.vivomar2018
(
...
load data local infile "P:\\My Documents\\My Documents\\Loaddata\\VivoMar2018.txt" 
into table loaddata.vivomar2018
...
select * from loaddata.vivomar2018;
