...
SELECT 
                       'CTRB:  Outpatient visit (budgeted)',
                       'CTRB: IOA',
                       'CTRB: Specimen drop off only',
                       'DIET: Controlled diet (foods weighed)',
                       'DIET: Regular meal',
                       'EQS: ECG machine',
                       'LAB: Specimen Processing - Hourly',
                       'LAB: Specimen processing - Instance',
                       'LAB: Specimen shipping',
                       'NUR: IP Medication administration',
                       'NUR: Nurse performed ECG',
                       'NUR: Nursing Service (Instance)',
                       'NUR: Scheduled nursing services',
                       'NUR: Specimen collection /Blood draw',
