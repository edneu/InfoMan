...
ALTER TABLE finance.hsc_map ADD OrigDeptName varchar(45);

UPDATE finance.hsc_map hm, lookup.deptlookup lu
SET hm.OrigDeptName=lu.Department
WHERE hm.DEPTID=lu.DEPTID;
